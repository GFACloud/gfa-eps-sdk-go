...
国富安证据保全服务是国富安公司基于区块链技术打造的证据保全在线服务，主要针对有证据保全需求的企业客户。

国富安证据保全服务SDK是针对国富安证据保全服务开发的Go版本的软件开发工具包，提供给企业客户完成与国富安证据保全服务的对接。
...
```
go get github.com/gfacloud/gfa-eps-sdk-go
```
